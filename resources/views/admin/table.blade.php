<x-admin-layout>
    <main class="w-full flex-grow p-6">
        <h1 class="text-3xl text-black pb-6">Output Data Tabel Penjualan </h1>
        ...
        <div class="w-full mt-6">
            <p class="text-xl pb-3 flex items-center">
                <i class="fas fa-list mr-3"></i> Tabel Penjualan
            </p>
                        ...
                        <div class="bg-white overflow-auto">
                            <table class="min-w-full bg-white">
                                <thead class="bg-red-600 text-black">
                                    <tr>
                                        <th class="text-left py-3 px-4 text-white font-light uppercase font-semibold text-sm">Id_Penjualan</th>
                                        <th class="text-left py-3 px-4 text-white font-light uppercase font-semibold text-sm">Kategori</th>
                                        <th class="text-left py-3 px-4 text-white font-light uppercase font-semibold text-sm">Tgl_Penjualan</th>
                                        <th class="text-left py-3 px-4 text-white font-light uppercase font-semibold text-sm">Berat</th>
